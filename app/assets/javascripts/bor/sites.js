...
function display_site(site_data){
  ...
  for(j=0; j<site_data['pictures'].length; j++){
    //alert(j);
    image_list.append('<li><img src="'+site_data['pictures'][j]+'"/>');
  }
  li = '<li><div class="grid_6"><div class="border"> <div class="carousel"> <ul>'+image_list.html()+'</ul> </div> <div class="nav"> <div class="left"> <a href="#"> previous </a> </div> <div class="center"></div> <div class="right"> <a href="#"> next </a> </div> <div class="clear"></div> </div> <div class="description padding"> <div class="left"> <a href="'+site_data['url']+'">' +site_data['title']+'</a> <a class="category" href="?category_id=34"> toto </a> </div> <div class="right"> </div> </div> </div>'
